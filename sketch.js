...
const BAR_H_BASE  = 50;
const MAX_DOT_R   = 300;
const MAX_WORD_FS = 250;
const MAX_PHOTO_W = 500;
const GROW_RATE   = 0.65;
...
// ── Wortlisten ────────────────────────────────────────────────────────────────
const WORDS_START = [
  "Wärme", "Haut", "Hand", "Finger", "Wange", "Schulter", "Rücken",
  "Puls", "Nähe", "Umarmung", "Halten", "Sanft", "Weich", "Kribbeln",
  "Gänsehaut", "Geborgen", "Vertraut", "Zuhause", "Ankommen",
  "Da sein", "Bei dir", "Ganz nah",
];
const WORDS_MIDDLE = [
  "Puls", "Atmung", "Zittern", "Kribbeln", "Gänsehaut", "Innenraum",
  "Spüren", "Ausbreiten", "Nachhallen", "Still",
  "Schwere", "Getragen", "Umhüllt", "Eingehüllt", "Aufgehen",
  "Versinken", "Verdichten", "Zu nah", "Zu viel",
];
const WORDS_END = [
  "Glas", "Display", "Oberfläche", "Glatt", "Kalt", "Still", "Lautlos",
  "Wischen", "Tippen", "Scrollen", "Weiter", "Endlos", "Fläche",
  "Gleiten", "Spurlos", "Verblassen", "Schatten", "Abbild",
  "Simulation", "Echo", "Schnell",
];
...
function initTiles() {
  ...
  for (let i = 0; i < TILE_COLS * TILE_ROWS; i++) {
    ...
    tiles.push({ x: x1, y: y1, w: x2 - x1, h: y2 - y1, delay: rank * 45, alpha: 0 });
  }
  tilesAnimating = true;
...
function drawStartScreen() {
  ...
  if (onboardVisible) {
    ...
    drawingContext.fillRect(textLeft - pad, ctaY - fs1 / 2 - pad, tw1 + pad * 2, fs1 + pad * 2);
    ...
    drawingContext.fillStyle = "rgb(255,255,255)";
    drawingContext.fillRect(text2Left - pad, line2Y - pad, tw2 + pad * 2, fs2 + pad * 2);
    drawingContext.fillStyle = "rgb(0,0,255)";
...
function easeOut(t) { return 1 - pow(1 - t, 2); }
